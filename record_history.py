...
local_line = """    getRecordingHistory: "../data/dvr/recording_history.json",//GET"""
server_line = """    getRecordingHistory: "%server%/pub/dvredge/devices/%deviceid%/recordings?statusfilter=1|2|4|5|6|7|8|10|11|12|13|14&token=%token%",//GET"""
...
org_line = """    getRecordingHistory:"""
new_line = """    getRecordingHistory: "../data/dvr/recording_history.json",//GET"""

# Check to see if arguements were passed and reset 
if len(argv) > 1:
	if argv[1] == 'revert':
		new_line = """    getRecordingHistory: "%server%/pub/dvredge/devices/%deviceid%/recordings?statusfilter=1|2|4|5|6|7|8|10|11|12|13|14&token=%token%",//GET"""
	else:
		new_line = """    getRecordingHistory: "../data/dvr/recording_history.json",//GET"""
